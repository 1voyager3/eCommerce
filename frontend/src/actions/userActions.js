...
import {
  ...
  USER_UPDATE_PROFILE_FAIL, USER_DETAILS_RESET, USER_LIST_FAIL,
  USER_LIST_SUCCESS, USER_LIST_REQUEST, USER_LIST_RESET,
...
export const login = ( email, password ) => async ( dispatch ) => {
  ...
  try {
    ...
    const config = {
      headers: {
        // @desc pointing a type of sending data to the server(backend)
